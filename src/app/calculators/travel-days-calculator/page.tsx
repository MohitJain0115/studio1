        ...
        <CardContent>
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-5">
              ...
              <AccordionContent>
                <p>Yes. The calculation is based on the actual time difference between the two dates, so it correctly handles the number of days in each month, including February in a leap year.</p>
              </AccordionContent>
            </AccordionItem>
